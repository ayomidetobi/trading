...
class IndexView(LoginRequiredMixin,TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        random_trades=self.generate_random_trades_periodically( minutes=0.25)
        context={
    ...
    def generate_random_trades_periodically(self, minutes):
        ...
        # trade=self.get_profit_loss_data().append(float(profit_loss))
        print(trade)
...
class UpdateChartDataView(View):
    def get(self.reques, request, *args, **kwargs):
        index_view = IndexView()
        trade = index_view.generate_random_trades_periodically(minutes=0.25)
        profit_loss_data = index_view.get_profit_loss_data()
        profit_loss_data.append(float(trade.profit_loss))
        return JsonResponse({'profit_loss_data': profit_loss_data})   
