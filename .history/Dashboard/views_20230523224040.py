...
class IndexView(LoginRequiredMixin,TemplateView):
    ...
    def get_context_data(self,reque **kwargs):
...
class UpdateChartDataView(TemplateView):
    def get(self, *args, **kwargs):
        view = IndexView(template_name='index.html')
        view.generate_random_trades_periodically(minutes=1, num_trades=1)
        profit_loss_data = view.profit_loss_data
