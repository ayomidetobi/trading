...
class UpdateChartDataView(View):
     def get(self, request, *args, **kwargs):
        ...
        # Load the static files using static() function
        static_js_file = staticfiles_storage.url('assets/vendor/apexcharts/apexcharts.min.js')
        static_css_file = staticfiles_storage.url(''assets/vendor/apexcharts/apexcharts.min.js')
        return render(request, 'index.html', {'profit_loss_data': profit_loss_data, 'time_data': time_data})
